...
public class CruisePassengerR extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					CruisePassengerR frame = new CruisePassengerR();
	...
	public CruisePassengerR() {
		...
		JLabel lblMonthlyInstallments = new JLabel("Cruise CruisePackage");
		...
		cmbCarModel.setModel(new DefaultComboBoxModel(new String[] {"Make a Selection", "CruisePackage A", "CruisePackage B", "CruisePackage C"}));
		...
		table.setModel(new DefaultTableModel(
			...
			new String[] {
				"Ref No", "Date", "Name", "IC/Passport", "Address", "Contact No", "Cruise CruisePackage", "Date of Booking", "Emergency Contact No", "Total Payment (RM)"
			}
		));
